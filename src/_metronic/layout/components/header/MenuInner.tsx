...
export function MenuInner() {
  ...
  return (
    <>
      ...
      {/* <MenuItem title='Inspeksi' to='/sheap/inspeksi' /> */}
      <MenuItem title='Excel' to='/behavior/excel' />
      <MenuItem title='Komplain' to='/behavior/komplain' />
      <MenuItem title='Hmtrip' to='/behavior/hmtrip' />
      <MenuItem title='Komplainopt' to='/behavior/komplainopt' />
    </>
  )
}
